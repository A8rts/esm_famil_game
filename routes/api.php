...
Route::post('get_rooms', [RoomController::class, 'get_rooms']);
...
Route::post('create_public_room', [CreateController::class, 'create_public_room']);
Route::post('create_private_room', [CreateController::class, 'create_private_room']);
