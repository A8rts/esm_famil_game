                    ...
                    <div className="px-4 py-1 my-5 text-center">
                        ...
                        <div className="col-lg-6 mx-auto">
                            <h3 className="lead mb-4">
                                نتایج بازی زمانی که به همه امتیاز دادین روی دکمه
                                (من امتیاز هایم را دادم ) بزنید
                            </h3>
                            <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
                                ...
                                {show_finish_score_button ? (
                                    ...
                                    <button className="btn btn-dark">صبر برای بازی دوباره</button>
                                )}
                            </div>
                            {answers.map((item) => (
                                <div
