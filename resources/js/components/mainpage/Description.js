            ...
            <div className="container px-4 py-5 text-center" id="featured-3">
                ...
                <div className="row g-4 py-3 row-cols-1 row-cols-lg-3">
                    ...
                    <div className="feature col">
                        ...
                        <h2>اتاق عمومی خصوصی چیه؟</h2>
                        <p>
                            اگر اتاقی که میسازید را عمومی درست کنید اتاقتان در صفحه ی (اتاق های عمومی) میرود و هر بازیکنی میتواند آن را ببیند و وارد آن شود.
                            ولی اگر خصوصی باشد فقط با کلید به آن اتاق میشود پیوست!
                        </p>
                    </div>
                    <div className="feature col">
                        <div className="mb-3">
